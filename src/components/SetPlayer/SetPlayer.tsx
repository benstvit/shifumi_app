    ...
    return (
      <>
       <div className="h-screen w-full flex justify-center items-center">
          <form
            className="flex flex-col justify-center items-center bg-gray-100 rounded-lg p-12"
            onSubmit={this.submitResults.bind(this)}>
            <label className="block mb-2 text-lg font-bold text-gray-900 dark:text-white">
              ENTER PLAYER NAME
              <input
                type="text"
                className="bg-gray-50 border border-gray-300 text-gray-900 text-sm text-center font-bold rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 my-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
